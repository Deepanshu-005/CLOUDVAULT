    ...
    <div className={`dashboard-bg ${theme}`}>
      <div className="dashboard">
        <div className="dashboard-header">
          <h1 className="dashboard-title center-title">CloudVault</h1>
        ...
        <section className="section-card">
          ...
          >
            ...
            <div className="upload-col">
              <label className="upload-label">Upload to Cloud (UploadThing)</label>
              <div className="cloud-upload-group">
                ...
                />
                <div className="uploadthing-hint"></div>
              </div>
            </div>
          </div>
          {uploadProgress > 0 && (
